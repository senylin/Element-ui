<template>
	<section>
     ...
     <el-breadcrumb separator="/" style='width:50%;float:left;font-size:18px;padding:10px 10px 10px 10px'>
        <el-breadcrumb-item :to="{ path: '/activeUsers/userinfo' }">用户档案</el-breadcrumb-item>
          <el-breadcrumb-item></el-breadcrumb-item>
      </el-breadcrumb>
			<el-form :inline="true" :model="filters" style="float:right">
				<el-form-item>
					<el-input v-model="filters.title" placeholder="数字id or 档案id"></el-input>
				</el-form-item>
				<el-form-item>
					<el-button type="primary" v-on:click="articleTable">查询档案</el-button>
				</el-form-item>
			</el-form>
		</el-col>
		<!--列表-->
      ...
      <el-table-column prop="uid" label="用户编号" width="120" sortable>
			...
			<el-table-column prop="rcid" label="档案编号" width="120" sortable>
			</el-table-column>
			<el-table-column prop="status" label="是否实名" width="120" sortable>
			</el-table-column>
      <el-table-column prop="rdate" label="入档时间" min-width="120" sortable>
      </el-table-column>
      <el-table-column prop="rdatec" label="最近修改" min-width="120" sortable>
      </el-table-column>
