<template>
    <div class="step1">
      ...
      <el-form :model="ruleForm" class="demo-ruleForm" :rules="rules" ref="ruleForm" label-position="top">
        ...
        <el-form-item label="" prop="fenLei">
          ...
          <el-row style="height: 35px;" type="flex" align="middle">
            <el-col :span="3" style="width: 90px;">
              <div class="el-form-item__label" style="padding-bottom: 0;"> 居住城市</div>
            </el-col>
            <el-col  class="" :span="2">
        ...
        <el-form-item label="咨询方向" required>
            <el-tag
...
<!--
     ...
     -->
        <el-form-item label="是否隐藏信息">
          <el-row>
          <el-col :span="6" style="width: 187px;">
            <el-radio class="radio" v-model="ruleForm.activePerson" label="无限制">隐藏</el-radio>
            <el-radio class="radio" v-model="ruleForm.activePerson" label="限制">公开</el-radio>
          </el-col>
          <!--
          <el-col :span="6">
