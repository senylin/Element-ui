<template>
	<section>
     ...
     <el-breadcrumb separator="/" style='width:50%;float:left;font-size:18px;padding:10px 10px 10px 10px'>
        <el-breadcrumb-item :to="{ path: '/activeUsers/userinfo' }">咨询服务</el-breadcrumb-item>
          <el-breadcrumb-item></el-breadcrumb-item>
			...
			<el-form :inline="true" :model="filters" style="float:right">
				...
				<el-form-item>
					<el-button type="primary" v-on:click="articleTable">查询业务</el-button>
				</el-form-item>
			</el-form>
		</el-col>
		<!--列表-->
		<el-table :data="articleTable" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;margin-bottom:30px;">
			...
			<el-table-column prop="sname" label="咨询师姓名" width="130" sortable>
			</el-table-column>
      <el-table-column prop="realname" label="用户姓名" width="120" sortable>
      </el-table-column>
      <el-table-column prop="sid" label="业务编号" width="120" sortable>
      </el-table-column>
			<el-table-column prop="type" label="所属类别" width="120" sortable>
			</el-table-column>
			<el-table-column prop="status" label="业务状态" width="120" sortable>
			</el-table-column>
      <el-table-column prop="rdate" label="开始时间" min-width="120" sortable>
      </el-table-column>
      <el-table-column prop="rdatec" label="截止时间" min-width="120" sortable>
      </el-table-column>
