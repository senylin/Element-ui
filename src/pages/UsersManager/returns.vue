<template>
	<section>
     ...
     <el-breadcrumb separator="/" style='width:50%;float:left;font-size:18px;padding:10px 10px 10px 10px'>
        <el-breadcrumb-item :to="{ path: '/activeUsers/userinfo' }">用户反馈</el-breadcrumb-item>
      ...
      <el-table-column prop="content" label="用户意见" min-width="200" sortable>
      </el-table-column>
      <el-table-column prop="date" label="反馈时间" width="120" sortable>
      </el-table-column>
