<template>
	<section>
     ...
     <el-breadcrumb separator="/" style='width:50%;float:left;font-size:18px;padding:10px 10px 10px 10px'>
        <el-breadcrumb-item :to="{ path: '/activeUsers/userinfo' }">用户实名</el-breadcrumb-item>
      ...
      <el-table-column prop="realname" label="真实姓名" width="120" sortable>
			...
			<el-table-column prop="status" label="身份证号" width="120" sortable>
			</el-table-column>
			<el-table-column prop="mobile" label="登记手机" min-width="120" sortable>
			</el-table-column>
      <el-table-column prop="status" label="审查状态" width="120" sortable>
      </el-table-column>
      <el-table-column inline-template label="操作" align="center" property="id">
          <el-button type="text" size="mini" @click.native="authUser">查看详情</el-button>
        </el-table-column>
		</el-table>
...
//	import { getUserListPage, removeUser, batchRemoveUser, editUser, addUser } from './js/api';
	...
	export default {
        ...
        this.activeNum = this.sels.length;
		  ...
		  authUser: function(){
		    window.location.href="#/activeUsers/authin/step1";
		  },
