<template>
    <div class="activePublic ">
      <el-steps :space="200" :active="step" class="step">
        <el-step title="上传证件" description=""></el-step>
        <el-step title="确认信息" description=""></el-step>
        <el-step title="证件审核" description=""></el-step>
        <el-step title="是否通过" description=""></el-step>
      </el-steps>
  ...
  <script>
    ...
    methods: {
      ...
      handleNextStep: function () {
          this.$router.push('/activeUsers/step'+(this.step+1));
          var _this = this;
          setTimeout(function () {
              if(_this.isRouter){
                  _this.step++;
